    ...
    <div className="bg-base border border-[#1e1e2e] rounded-2xl p-4">
      ...
      <div className="flex items-center justify-between mb-4">
        <button 
          ...
          className="p-2 hover:bg-elevated rounded-lg text-secondary hover:text-primary"
        >
          ←
        </button>
      ...
      <div className="grid grid-cols-7 gap-1 mb-2">
        {dayNames.map(day => (
          <div key={day} className="text-center text-secondary text-xs font-medium py-1">
            {day}
          </div>
        ))}
      </div>
...
function EventsPageContent() {
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-4">
            <div className="text-right">
              <div className={`font-bold text-lg ${event.isFree ? 'text-green-400' : 'text-accent'}`}>
                {event.entryFee}
              </div>
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className="px-3 py-2 bg-elevated text-primary rounded-lg text-sm hover:bg-elevated"
              >
                📤 Share
              </button>
            </div>
  ...
  const EventDetailModal = ({ event, onClose }: { event: CalendarEvent; onClose: () => void }) => (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      <div className="absolute inset-0 bg-black/80" onClick={onClose} />
      <div className="relative bg-surface rounded-2xl w-full max-w-lg max-h-[90vh] overflow-auto">
        {/* Header */}
        <div 
        ...
        >
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <div className="text-primary">{event.game?.name || 'General Event'}</div>
            </div>
          </div>
        </div>
        ...
        <div className="p-6 space-y-4">
          ...
          {/* Entry Fee & Spots */}
          <div className="flex gap-4">
            <div className="flex-1 bg-gradient-to-r from-cyan-500/10 to-blue-500/10 rounded-xl p-4 border border-accent/20">
        ...
        <div className="p-4 border-t border-token">
          <div className="flex gap-2">
            ...
            <button
              ...
              className="px-6 py-3 bg-elevated text-primary rounded-xl font-bold hover:bg-elevated"
            >
              📤
            </button>
          </div>
          <p className="text-secondary text-xs text-center mt-2">Registration handled in-store</p>
        </div>
      </div>
    </div>
  );
        ...
        <div className="px-4 lg:px-8 py-4">
          <div className="flex items-center justify-between mb-4">
            ...
            <button
              onClick={handleSync}
              disabled={syncing}
              className="px-3 py-1.5 bg-elevated text-primary rounded-lg text-sm hover:bg-elevated disabled:opacity-50 flex items-center gap-2"
            >
              ...
              <button
                ...
                className={`flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-sm whitespace-nowrap transition-all ${
                  !selectedGames.has('all') && favoriteGames.every(g => selectedGames.has(g)) && selectedGames.size === favoriteGames.length
                    ? 'bg-gradient-to-r from-cyan-500 to-purple-500 text-primary'
          ...
          <div className="lg:flex lg:gap-6">
                ...
                <div className="mt-4 bg-base border border-[#1e1e2e] rounded-2xl p-4">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div className="bg-elevated/50 rounded-lg p-3 text-center">
                      ...
                      <div className="text-secondary text-xs">Events</div>
                    </div>
                    <div className="bg-elevated/50 rounded-lg p-3 text-center">
                      <div className="text-2xl font-bold text-purple-400">
                        {events.filter(e => e.isInterested).length}
                      </div>
                      <div className="text-secondary text-xs">Interested</div>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="flex-1 space-y-6">
              {Object.entries(groupedEvents).length === 0 ? (
                <div className="text-center py-12">
                  <div className="text-4xl mb-4">🔍</div>
                  <div className="text-primary font-bold">No events match your filters</div>
                  <div className="text-secondary text-sm mt-2">
  ...
  return (
    <div className="flex-1 p-4 lg:p-8">
      <div className="animate-pulse">
        ...
        <div className="lg:flex lg:gap-6">
          <div className="w-80 h-96 bg-elevated rounded-2xl hidden lg:block"></div>
