    ...
    <div className="flex-1 overflow-auto p-4">
      <div className="animate-pulse">
        ...
        <div className="text-center mb-6">
          <div className="h-8 bg-slate-800 rounded w-48 mx-auto mb-2"></div>
          <div className="h-4 bg-slate-800 rounded w-32 mx-auto"></div>
        </div>
        
        {/* Profile card skeleton */}
        <div className="h-40 bg-slate-800 rounded-2xl mb-4"></div>
        ...
        <div className="h-6 bg-slate-800 rounded w-32 mb-3"></div>
