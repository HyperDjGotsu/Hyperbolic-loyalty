-- Migration: 20260716103752_fix_create_prize_redemption_columns
...
--   npx supabase migration repair --status applied 20260716103752
--
-- NOTE: This is an intermediate version of create_prize_redemption that matched
-- the newly rebuilt prize_wall_redemptions schema (claim_code, points_deducted, etc.).
-- It was superseded by 20260720025209 (store-scoped balance) and then again by
-- 20260801_fix_prize_redemption_network_wide_balance. The live function body is the
-- 20260801 version; this file captures the intermediate step for history.
...
BEGIN
  ...
  -- Balance check: store-scoped (intermediate version; superseded by network-wide check)
