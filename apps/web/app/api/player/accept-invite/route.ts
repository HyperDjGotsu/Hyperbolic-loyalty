...
// Live SQL function returns { ok: true/false, code?: string, store_id?, role?, ... }
// Error codes: NOT_FOUND, REVOKED, ALREADY_ACCEPTED, EXPIRED, EMAIL_MISMATCH, WOULD_DOWNGRADE
